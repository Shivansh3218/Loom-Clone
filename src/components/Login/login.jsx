  ...
  return (
    ...
    <div className="context">
      ...
      <div className="login-apps">
        ...
        <p classname="companies"style={{fontSize:"0.7rem"}}>Login with Apple</p >
        </div>
        <div className="login-apps">
        <img src={slack} id="apple" alt="" />
        <p classname="companies" style={{fontSize:"0.7rem"}}>Login with Slack</p >
        </div>
        <div className="login-apps">
        <img src={outlook} id="apple" alt="" />
        <p classname="companies"style={{fontSize:"0.7rem"}}>Login with Outlook</p>
        </div>
        <p style={{color:"black"}}>By signing up, you acknowledge that you have read and understood, and agree to Our Terms and Privacy Policy.</p>
      </div>
